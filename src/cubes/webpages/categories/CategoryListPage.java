...
public class CategoryListPage {
	...
	public void clickOnDeleteCategory(String name) {
		driverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//strong[text()='"+name+"']//ancestor::tr//td[6]//i[@class='fas fa-trash']")));
		WebElement weDeleteButton = driver.findElement(By.xpath("//strong[text()='"+name+"']//ancestor::tr//td[6]//i[@class='fas fa-trash']"));
